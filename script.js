// Hide logo bar on mobile after clicking a menu link
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (menuToggle && navLinks && logo) {
        ...
        menuToggle.addEventListener('click', function() {
            if (isMobile()) {
                // If menu is opening, show logo again
        ...
        // Show logo again on resize to desktop
